'''
https://ntguardian.wordpress.com/about-me/
'''
...
ts = TimeSeries(key='6EJ3GC00Q0HM97XN', output_format='pandas')
data, meta_data = ts.get_intraday(symbol='TCEHY',interval='1min', outputsize='full')
#data['close'].plot()
#plt.title('Intraday Times Series for the TCEHY stock (1 min)')
#plt.show()
...
apple = data.DataReader("TCEHY", "yahoo", start, end)
